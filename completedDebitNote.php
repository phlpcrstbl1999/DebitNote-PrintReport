...
$sql = "Select min(dn_no) as min from debit_tbl";
$query = sqlsrv_query($con, $sql);
if($query) {
    while($row = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC)){     
        $minDN = $row['min']; 
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active1" aria-current="page">Printed Debit Note</li>
                            </ol>
                            </nav>
                        ...
                        <div class="page-header float-right">
                            <button class="buttonDownload" data-toggle="modal" data-target="#exportReport" name="completeSubmit"><b>Export to Excel</b></button>
                                </div>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered example">
                                    ...
                                    <tbody>
                                        <?php
                                                ...
                                                $sql = "SELECT * from debit_tbl where forPrint = 'N' AND name is not null";
                                        ...
                                        <tr>
                                            ...
                                            ?>  
                                                <img src="images/cancelled.png" width="25px" height="25px">
                                            <?php
                                                } else {
                                            ...
                                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#cancelDN<?php echo $row['dn_no'];?>"><i class="fa fa-ban"></i></button> 
                                            <?php
                                                } else {
                                            ?>
                                            <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#editfilecategory<?php echo $row['dn_no'];?>" disabled><i class="fa fa-pencil"></i></button> 
                                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#cancelDN<?php echo $row['dn_no'];?>" disabled><i class="fa fa-ban"></i></button> 
                                            <?php        
                                                }
                                            }
                                            ?>
                                            ...
                                            ?>
                                                <button type="submit" name="submit" class="btn btn-sm" style="background-color:#b700b1; color: #fff;"><i class="fa fa-print"></i> Print</button>
                                                <?php
                                                }
                                            ?>
                                            </td>
        ...
        <!-- ########################################################EDITEDITEDITEDIT############################################################################################# -->
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                        <button type="submit" name="editReport" class="btn btn-primary">Confirm</button>
                                                </div>
                                                    </form>
                                                    </div>
                                ...
                                <!-- ################################################CANCELCANCELCANCEL############################################################################################################################# -->
                                <div class="modal fade" id="cancelDN<?php echo $row['dn_no'];?>" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                            <form action="backend/insertReport.php" method="post" class="needs-validation" novalidate>
                                                                <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                    <div class="card-header"><strong>Are you sure you want to cancel?</strong><small></small></div>
                                                        <div class="card-body card-block">
                                                        <div class="form-group row">
                                                            <label for="staticEmail" class="col-sm-2 col-form-label"><b>Debit Note</b></label>
                                                            <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="staticEmail" class="col-sm-2 col-form-label"><b>Name</b></label>
                                                            <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="name" id="suggestion" placeholder="Enter Name" value="<?php echo $row['name'];?>" readonly>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                    </div>
                                                                    <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="staticEmail" class="col-sm-2 col-form-label"><b>Date</b></label>
                                                            <div class="col-sm-3">
                                                            <input type="date" class="form-control" name="date" id="validationCustom02" value="<?php echo date('Y-m-d', strtotime($row['date'])); ?>" readonly>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                    </div>
                                                                    <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="staticEmail" class="col-sm-2 col-form-label"><b>Amount</b></label>
                                                            <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="amount" id="validationCustom02" value="<?php echo $row['amount'];?>" placeholder="Enter Amount" readonly>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                    </div>
                                                                    <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <textarea class="form-control" name="particular" id="exampleFormControlTextarea1" rows="7" readonly><?php echo $row['particulars'];?></textarea>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
                                                        <button type="submit" name="cancelReport" class="btn btn-primary">Yes</button>
                                                </div>
                                                    </form>
                                                    </div>
                            ...
                            <div class="modal fade" id="exportReport" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                            <form action="backend/exportExcel.php" method="post" class="needs-validation" novalidate>
                                                                <div class="modal-header">
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                        ...
                                                        <div class="modal-body">
                                                    <div class="card-header"><strong>Export Report</strong><small> Form</small></div>
                                                        <div class="card-body card-block">
                                                        <div class="form-group row">
                                                            <label for="staticEmail" class="col-sm-2 col-form-label"><b>Export By</b></label>
                                                            <div class="col-sm-7">
                                                                <select class="form-control" id="exportBy" name="exportBy">
                                                                    <option value="date">Date</option>
                                                                    <option value="dnNumber">DN number</option>
                                                        ...
                                                        <div class="form-group row">
                                                        <label id="forDate" class="col-sm-2 col-form-label"><b>Date</b></label>
                                                        <div class="col-sm-3">
                                                            From:
                                                            <input type="date" class="form-control" id="fromDate" name="fromDate" onchange="from(event);" required>
                                                            </div>
                                                            <div class="col-sm-3">
                                                            To:
                                                            <input type="date" class="form-control" id="toDate" name="toDate" onchange="to(event);" required>
                                                            </div>
...
<!-- ########################################################################################################################################################################### -->
                                                        <div id="dnRange" style="display:none">                                                  
                                                        <div class="form-group row">
                                                        <label id="forDNnumber" class="col-sm-2 col-form-label"><b>DN number </b></label>
                                                        <div class="col-sm-3">
                                                            From:
                                                            <input type="number" min="<?php echo $minDN?>" class="form-control" id="fromDN" name="fromDN">
                                                            </div>
                                                            <div class="col-sm-3">
                                                            To:
                                                            <input type="number" max="<?php echo $maxDN?>" class="form-control" id="toDN" name="toDN">
                                                            </div>
...
<!-- ########################################################################################################################################################################### -->
                                                        ...
                                                        <div class="form-group row">
                                                        <label id="forName" class="col-sm-2 col-form-label"><b>Name</b></label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="nameReport" name="nameReport">
                                                            </div>
                                                        <input type="hidden" class="form-control" name="userid" value="<?php echo $userid?>">
                                                        </div>
                                                        </div>
<!-- ########################################################################################################################################################################### -->
                                                        <div id="particularsRange" style="display:none">                                                  
                                                        <div class="form-group row">
                                                        <label for="forParticulars" class="col-sm-2 col-form-label"><b>Particular</b></label>
                                                        <div class="col-sm-10">
                                                        <textarea class="form-control" name="particularsReport" id="particularsReport" rows="7"></textarea>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                        <button type="submit" name="exportExcel" class="btn btn-primary">Export</button>
                                                </div>
                                                    </form>
                                                    </div>
    ...
    <script src="backend/main.js"></script>
                                     ...
                                     <script>
                                        ...
                                        <script>
                                            ...
                                            $(document).ready(function(e) {
                                                $("#fromDN").autocomplete({
                                                    source:'backend/suggestions/dnSuggestion.php'
                                                });
                                                $("#toDN").autocomplete({
                                                    source:'backend/suggestions/dnSuggestion.php'
                                                });
                                            ...
                                            $(document).ready(function(e) {
                                                $("#nameReport").autocomplete({
                                                    source:'backend/suggestions/nameSuggestion.php'
                                                });
                                            });

                                            $(document).ready(function(e) {
                                                $("#particularsReport").autocomplete({
                                                    source:'backend/suggestions/particularsSuggestion.php'
                                                });
                                            });
                                        </script>
</body> 
