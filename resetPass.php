                ...
                <div class="login-form">
                    <form action="backend/reset.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="form-group row">
                            ...
                            ?>
                            <div class="col">
                                <a href="createDebitNote.php" class="btn btn-danger btn-flat m-b-30 m-t-30" role="button" aria-pressed="true">Back</a>
                            </div>
                            <?php 
                                    ...
                                    ?>
                                <div class="col">
                                <a href="completedDebitNote.php" class="btn btn-danger btn-flat m-b-30 m-t-30" role="button" aria-pressed="true">Back</a>
                            </div>
                            <?php
                                }
                            ?>
