...
<body>
    ...
    <script>
     ...
     <script>
        // $('#register').on('click', function() {
        <?php
            if(isset($_SESSION['statusLogin']) && $_SESSION['status_codeLogin'] != '' ) {
        ?>    
            swal.fire({
                icon: '<?php echo $_SESSION['status_codeLogin']; ?>',
                title: '<?php echo $_SESSION['statusLogin']; ?>',
                text: '<?php echo $_SESSION['status_textLogin']; ?>'
            })
        // })
        <?php 
            unset($_SESSION['statusLogin']);
            unset($_SESSION['status_codeLogin']);
            unset($_SESSION['status_textLogin']);
        }
